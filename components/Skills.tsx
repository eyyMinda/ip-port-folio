...
export default function Skills({ dark, skills }: Props) {
  return <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}
    ...
    <h3 className='sectionHeading normal-case w-[95vw] sm:w-[75vw] lg:w-[60vw] top-36 text-sm tracking-widest'>
      Percentages reflect my practical experience with each skill rather than a comprehensive mastery of all aspects. Think of them as gauges of my ability to implement these skills effectively in real-world projects.
    </h3>
